...
def gen_boxplots(file, savedir="."):
    ...
    os.path.join(savedir, "gen_boxplots")
    print("Saving boxplot of generation variables to " + savedir)

    # Outlier and non-outlier folders
    nout_folder = os.path.join(savedir, "noutliers")
    out_folder = os.path.join(savedir, "outliers")
...
def supply_histogram(file, savedir, show=False):
    ...
    print("Saving histograms of supply-curve variables to " + graphdir)
